...
var AllEventFlowEntry = defineObject(BaseFlowEntry,
{
	...
	_damagehit: function(generator, targetUnit, command) {
		generator.damageHitEx(targetUnit, command.getDamageAnime(), command.getDamageValue(), command.getDamageType(), command.getHit(), command.getLaunchUnit(), this._isCommandSkip(command));
	},
